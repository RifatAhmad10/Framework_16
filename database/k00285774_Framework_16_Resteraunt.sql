CREATE DATABASE  IF NOT EXISTS `k00285774_framework_16_resteraunt` /*!40100 DEFAULT CHARACTER SET latin1 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `k00285774_framework_16_resteraunt`;
-- MySQL dump 10.13  Distrib 8.0.36, for Win64 (x86_64)
--
-- Host: localhost    Database: k00285774_framework_16_resteraunt
-- ------------------------------------------------------
...
CREATE TABLE `order` (
  ...
  CONSTRAINT `fk_customer` FOREIGN KEY (`customer`) REFERENCES `user` (`UserNr`),
  CONSTRAINT `fk_dish_12` FOREIGN KEY (`dish`) REFERENCES `restaurantdishes` (`DishID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `order` VALUES (2,3,1),(2,7,2),(46,7,1),(46,8,2);
/*!40000 ALTER TABLE `order` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `restaurant_supplies`
--

DROP TABLE IF EXISTS `restaurant_supplies`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `restaurant_supplies`
--

LOCK TABLES `restaurant_supplies` WRITE;
/*!40000 ALTER TABLE `restaurant_supplies` DISABLE KEYS */;
INSERT INTO `restaurant_supplies` VALUES (1,'Fresh Produce','Local Farms Co.',500,1.50,'2024-04-18'),(2,'Meat','Prime Meats Inc.',200,5.00,'2024-04-19'),(3,'Dairy Products','Farm Fresh Dairy',100,3.00,'2024-04-20'),(4,'Seafood','Ocean Delights',150,8.50,'2024-04-21'),(5,'Beverages','Distributor X',300,1.20,'2024-04-22'),(6,'Poultry','Fresh Poultry Farms',250,4.50,'2024-04-23');
/*!40000 ALTER TABLE `restaurant_supplies` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `user` (
  ...
  `userEnabled` tinyint DEFAULT '1',
  PRIMARY KEY (`UserNr`),
  UNIQUE KEY `email_UNIQUE` (`email`),
  UNIQUE KEY `userID_UNIQUE` (`userID`),
  KEY `fk_admin_county2_idx` (`idcounty`),
  KEY `fk_user_userType1_idx` (`userTypeNr`),
  CONSTRAINT `fk_admin_county2` FOREIGN KEY (`idcounty`) REFERENCES `county` (`idcounty`),
  CONSTRAINT `fk_user_userType1` FOREIGN KEY (`userTypeNr`) REFERENCES `usertype` (`userTypeNr`)
...
-- Dump completed on 2024-04-19 17:46:35
